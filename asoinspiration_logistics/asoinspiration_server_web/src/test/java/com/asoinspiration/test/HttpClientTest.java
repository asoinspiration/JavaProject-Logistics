...
import com.asoinspiration.utils.HttpClientUtil;
...
public class HttpClientTest {
	...
	public void testHttpUtils(){
		...
		String doPost = HttpClientUtil.doPost("http://localhost:8080/ai_logistics/loginAction_login",map);
		String zTreeJson = HttpClientUtil.doGet("http://localhost:8080/ai_logistics/sysadmin/roleAction_genzTreeNodes?id=4028a1c34ec2e5c8014ec2ebf8430001");
