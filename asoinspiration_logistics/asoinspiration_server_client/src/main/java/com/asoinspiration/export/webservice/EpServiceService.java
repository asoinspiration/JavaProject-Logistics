 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.export.asoinspiration.com/", wsdlLocation = "http://localhost:8090/ae/ws/export?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EPSERVICESERVICE_QNAME = new QName("http://webservice.export.asoinspiration.com/", "EpServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/ae/ws/export?wsdl");
    ...
    public IEpService getEpServicePort() {
        return super.getPort(new QName("http://webservice.export.asoinspiration.com/", "EpServicePort"), IEpService.class);
    }
    ...
    public IEpService getEpServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.export.asoinspiration.com/", "EpServicePort"), IEpService.class, features);
    }
